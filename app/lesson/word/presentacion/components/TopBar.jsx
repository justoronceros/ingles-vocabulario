  ...
  return (
    <div className="h-full flex gap-2 justify-between mx-2">
      ...
      <div className="flex items-center w-full px-2">
              <div className="w-full h-[30%] bg-gray-200 rounded-2xl overflow-hidden">
                  <div className="bg-yellow-400 h-full w-[15%] rounded-r-2xl transition-all duration-500"></div>
        </div>
      </div>
